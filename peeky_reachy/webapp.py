...
def main():
    ...
    # its `meshes/*.stl` references. `allowed_paths` whitelists the assets
    # directory for Gradio's static-file route; the head script (built by
    # `reachy3d.head_html(urdf_url=...)`) points at /file=assets/.../urdf.
    ...
    app.launch(
        ...
        head=reachy3d.head_html(urdf_url="/gradio_api/file=assets/reachy_mini/reachy_mini.urdf"),
        allowed_paths=[os.path.join(repo_root, "assets")],
    )
